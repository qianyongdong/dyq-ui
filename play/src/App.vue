...
<template>
    <div class="app">
        <!-- component test -->
        <!-- <section class="list">
            <d-viewer ref="viewerRef" :src="pdfUrl" @rendered="onRendered" @error="onError"></d-viewer>
            <d-viewer ref="viewerRef" :src="tifUrl" @rendered="onRendered" @error="onError"></d-viewer>
            <d-viewer ref="viewerRef" :src="bmpUrl" @rendered="onRendered" @error="onError"></d-viewer>
            <d-viewer ref="viewerRef" :src="imgUrl" @rendered="onRendered" @error="onError"></d-viewer>
        </section> -->
