import{D as s}from"./index-DSS6_je-.js";import"./vue.esm-bundler-CLOMPI_r.js";import"./iframe-DDbmkL37.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";const n=Array.from({length:9},(e,t)=>t+1),I={title:"组件/容器组件(CONTAINMENT)/列表(List)",component:s,tags:["autodocs"],argTypes:{modelValue:{required:!0,description:"v-model绑定的列表数组"},column:{type:"number",description:"列数"},row:{type:"number",description:"行数"},gap:{type:"string",description:"间隔,像素单位 px | em | %"},itemHeight:{type:"string",description:"子元素高度,优先级比row属性高,像素单位 px | em | %",control:!1},itemWidth:{type:"string",description:"子元素宽度,优先级比column属性高,像素单位 px| em | %",control:!1},disabled:{description:"是否禁用拖拽",defaultValue:!1},onEnd:{type:"function",description:"监听拖动结束时，返回 SortableEvent 对象"}},args:{modelValue:n,column:4,row:4,gap:"0px",disabled:!1}},u={args:{disabled:!0}},l=({})=>({components:{DList:s},data(){return{modelValue:[...n],gap:"10px",row:3,column:3}},methods:{insertAtIndex(e,t,x=!1){const b=x?(Array.isArray(t)?t.length:1)+e:e;this.modelValue=[...this.modelValue.slice(0,e),...Array.isArray(t)?t:[t],...this.modelValue.slice(b)]},resetModelValue(){this.modelValue=[...n]}},template:`
  <div class="a-100">
